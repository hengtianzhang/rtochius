...
"""
Linter for the rtochius Kconfig files. Pass --help to see
...
def modules_file_dir():
    ...
    run((os.path.join("scripts", "rtochius_module.py"),
...
def run(cmd, cwd=TOP_DIR, check=True):
    ...
    # the working directory. It defaults to the top-level rtochius directory.
