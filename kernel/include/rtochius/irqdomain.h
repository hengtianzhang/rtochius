...
#ifndef __RTOCHIUS_IRQDOMAIN_H_
#define __RTOCHIUS_IRQDOMAIN_H_
...
static inline struct irq_domain *irq_domain_create_tree(struct fwnode_handle *fwnode,
					 ...
					 void *host_data)
{
	return __irq_domain_add(fwnode, ~0, ops, host_data);
}
...
static inline struct irq_domain *irq_domain_add_hierarchy(struct irq_domain *parent,
					    ...
					    void *host_data)
{
	return irq_domain_create_hierarchy(parent, flags,
...
{
	return __irq_domain_alloc_irqs(domain, -1, nr_irqs, arg, false,
				       NULL);
}
