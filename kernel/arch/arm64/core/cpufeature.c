...
bool cpu_hwcap_keys[ARM64_NCAPS] = {[0 ... (ARM64_NCAPS - 1)] = false};
bool arm64_const_caps_ready = false;
...
#include <rtochius/irqchip/arm-gic-v3.h>
