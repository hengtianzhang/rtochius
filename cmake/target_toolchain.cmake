...
set(CMAKE_SYSTEM_VERSION ${RTOCHIUS_PROJECT_VERSION})

# We are not building dynamically loadable libraries
set(BUILD_SHARED_LIBS OFF)

if(NOT (COMPILER STREQUAL "host-gcc"))
	include(${TOOLCHAIN_ROOT}/cmake/toolchain/${RTOCHIUS_TOOLCHAIN}/target.cmake)
endif()
...
# In rtochius, toolchains require a port under cmake/toolchain/.
...
include(${TOOLCHAIN_ROOT}/cmake/linker/${LINKER}/target.cmake)
include(${TOOLCHAIN_ROOT}/cmake/bintools/bintools_template.cmake)
include(${TOOLCHAIN_ROOT}/cmake/bintools/${BINTOOLS}/target.cmake)
