...
set(KCONFIG_ROOT ${RTOCHIUS_BASE}/Kconfig)
...
if(DEFINED KCONFIG_FILE)
	...
	unset(RTOCHIUS_DEFCONFIG)
	unset(RTOCHIUS_DEFCONFIG CACHE)
endif()

if(NOT RTOCHIUS_DEFCONFIG AND (NOT DEFINED KCONFIG_FILE))
	find_file(RTOCHIUS_DEFCONFIG defconfig ${RTOCHIUS_BASE}/kernel/arch/${ARCH}/configs)
else()
	find_file(RTOCHIUS_DEFCONFIG ${KCONFIG_FILE} ${RTOCHIUS_BASE}/kernel/arch/${ARCH}/configs)
endif()

if (RTOCHIUS_DEFCONFIG STREQUAL RTOCHIUS_DEFCONFIG-NOTFOUND)
...
message(STATUS "Kconfig file: ${RTOCHIUS_DEFCONFIG}")
...
set(COMMON_KCONFIG_ENV_SETTINGS
	...
	srctree=${RTOCHIUS_BASE}
	RTOCHIUS_VERSION_STRING=${RTOCHIUS_VERSION_STRING}
...
set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_menuconfig
	${RTOCHIUS_BASE}/scripts/kconfig/menuconfig.py
	)

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_guiconfig
	${RTOCHIUS_BASE}/scripts/kconfig/guiconfig.py
	)

set(EXTRA_KCONFIG_TARGET_COMMAND_FOR_hardenconfig
	${RTOCHIUS_BASE}/scripts/kconfig/hardenconfig.py
	)
...
foreach(kconfig_target
	...
	add_custom_target(
		...
		RTOCHIUS_TOOLCHAIN=${RTOCHIUS_TOOLCHAIN}
...
execute_process(
	...
	${PYTHON_EXECUTABLE}
	${RTOCHIUS_BASE}/scripts/kconfig/kconfig.py
	--rtochius-base=${RTOCHIUS_BASE}
...
if(CREATE_NEW_DOTCONFIG)
	...
	# succeeds, to avoid marking rtochius/.config as up-to-date when it hasn't been
	# regenerated.
...
execute_process(
	...
	${RTOCHIUS_BASE}/scripts/mkkconfig_h.py
	-o ${KCONFIG_H}
